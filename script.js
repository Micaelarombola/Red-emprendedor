(() => {
  const SUPABASE_URL = "https://ltcoeuivvcrkgtkprqzb.supabase.co";
          ...
          <div class="expanded-grid">
            <div>
              <div class="info-panel">
                ...
                <strong>Cómo ayudar:</strong> ${e.helpText || e.help_text || "Podés apoyarlo compartiendo, recomendando o comprando."}
              </div>
